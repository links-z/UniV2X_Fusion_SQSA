...
load_from = None
resume_from = 'projects/work_dirs_e2e_univ2x/univ2x_ablation_wo_complement/wo_complement_iter_300.pth'
auto_resume = False

work_dir = 'projects/work_dirs_e2e_univ2x/univ2x_ablation_wo_complement_cont_from300'
...
checkpoint_config = dict(
    ...
    interval=100,
    max_keep_ckpts=20,
    filename_tmpl='wo_complement_s2_iter_{}.pth'
)

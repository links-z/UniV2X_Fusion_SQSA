_base_ = ['./univ2x_ablation_wo_sinkhorn.py']

load_from = None
resume_from = 'projects/work_dirs_e2e_univ2x/univ2x_ablation_wo_sinkhorn_cont_from300/wo_sinkhorn_s2_iter_600.pth'
auto_resume = False

work_dir = 'projects/work_dirs_e2e_univ2x/univ2x_ablation_wo_sinkhorn_cont_from600'
...
checkpoint_config = dict(
    ...
    interval=100,
    max_keep_ckpts=20,
    filename_tmpl='wo_sinkhorn_s3_iter_{}.pth'
)

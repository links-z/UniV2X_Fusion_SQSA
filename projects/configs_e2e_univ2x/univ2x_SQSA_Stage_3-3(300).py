...
load_from = None
resume_from = 'projects/work_dirs_e2e_univ2x/univ2x_A_continue_unfreeze_bboxhead_from300/latest.pth'
auto_resume = False

work_dir = 'projects/work_dirs_e2e_univ2x/univ2x_A_cont_from600'
...
checkpoint_config = dict(
    ...
    interval=100,
    max_keep_ckpts=20,
    filename_tmpl='A_cont_from600_iter_{}.pth'
)

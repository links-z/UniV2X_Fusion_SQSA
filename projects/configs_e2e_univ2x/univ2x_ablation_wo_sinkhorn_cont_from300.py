...
load_from = None
resume_from = 'projects/work_dirs_e2e_univ2x/univ2x_ablation_wo_sinkhorn/wo_sinkhorn_iter_300.pth'
auto_resume = False

work_dir = 'projects/work_dirs_e2e_univ2x/univ2x_ablation_wo_sinkhorn_cont_from300'
...
checkpoint_config = dict(
    ...
    interval=100,
    max_keep_ckpts=20,
    filename_tmpl='wo_sinkhorn_s2_iter_{}.pth'
)
